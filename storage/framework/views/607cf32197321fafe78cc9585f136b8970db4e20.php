...
<body>
    <div class="container">
        ...
        <h1>Doctor Login</h1>
        <form method="POST" action="<?php echo e(route('doctor.fakeLogin')); ?>">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\USER\PycharmProjects\CaD\call-a-doctor\resources\views/doctor/login.blade.php ENDPATH**/ ?>