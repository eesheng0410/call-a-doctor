...
<body>
    <div class="container">
        ...
        <div class="link-group">
            <a href="<?php echo e(route('patient.signup')); ?>">Don't have an account? Sign up here</a>
            <a href="<?php echo e(route('login.selection')); ?>">Back to Login Selection</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\USER\PycharmProjects\CaD\call-a-doctor\resources\views/patient/login.blade.php ENDPATH**/ ?>