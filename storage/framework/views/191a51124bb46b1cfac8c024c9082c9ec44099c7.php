...
<body>
    <div class="container">
        ...
        <h1>Call-A-Doctor</h1>
        <div class="btn-group">
            <button class="btn" onclick="window.location='<?php echo e(route('patient.login')); ?>'">Patient</button>
            <button class="btn" onclick="window.location='<?php echo e(route('clinic.login')); ?>'">Clinic</button>
            <button class="btn" onclick="window.location='<?php echo e(route('doctor.login')); ?>'">Doctor</button>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\USER\PycharmProjects\CaD\call-a-doctor\resources\views/login_selection.blade.php ENDPATH**/ ?>