...
<body>
    ...
    <div class="container">
        <div class="appointments-header">
            <h2>Appointments</h2>
            <form method="POST" action="<?php echo e(route('clinic.updateAllAppointments')); ?>">
                <?php echo csrf_field(); ?>
                <button type="submit" class="update-all-button">Update All</button>
        </div>
...
<?php /**PATH C:\Users\USER\PycharmProjects\CaD\call-a-doctor\resources\views/clinic/appointment.blade.php ENDPATH**/ ?>