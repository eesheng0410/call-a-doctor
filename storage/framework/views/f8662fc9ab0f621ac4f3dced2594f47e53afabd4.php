        ...
        <table>
            ...
            <tbody id="clinicTableBody">
                <?php $__currentLoopData = $clinics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clinic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr data-area="<?php echo e($clinic->area); ?>">
                        <td><?php echo e($clinic->name); ?></td>
                        <td><?php echo e($clinic->area); ?></td>
                        <td>
                            <a href="<?php echo e(route('patient.bookClinicForm', ['clinic' => $clinic->id])); ?>" class="book-button">Book</a>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
...
<?php /**PATH C:\Users\USER\PycharmProjects\CaD\call-a-doctor\resources\views/patient/book_appointment.blade.php ENDPATH**/ ?>