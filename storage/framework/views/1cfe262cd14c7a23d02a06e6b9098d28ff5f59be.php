...
<body>
    ...
    <div class="container">
        ...
        <div class="profile-info">
            <p><label>Name:</label> <?php echo e(auth()->user()->name); ?></p>
            <p><label>Email:</label> <?php echo e(auth()->user()->email); ?></p>
        </div>
        <h2>Change Password</h2>
        <form method="POST" action="<?php echo e(route('patient.updatePassword')); ?>">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\USER\PycharmProjects\CaD\call-a-doctor\resources\views/patient/profile.blade.php ENDPATH**/ ?>